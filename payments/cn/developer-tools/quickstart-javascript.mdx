...
- 您已[生成 API Key 和 API Secret](/payments/cn/developer-tools//cobo-auth#generate-an-api-key-and-an-api-secret)，并在 Cobo Portal 上[注册了 API Key](https://manuals.cobo.com/en/portal/developer-console/create-api-key)。
