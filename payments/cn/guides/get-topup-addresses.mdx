...
<Tabs>
  <Tab title="Payments App" icon="pager">
    ...
    4. 点击右上角的**创建付款方**按钮。
    5. 在弹出的表单中：
       - 选择商户。该付款方充值地址收到的充币会通过付款方进行归属，并路由到创建该付款方及地址时绑定的商户。完整的资金归属模型请参考[账户与资金分配](/payments/cn/guides/amounts-and-balances#充币归属)。
...
- **资金处理**：该地址与商户的关联关系依然存在，更换地址后充币仍会归属到同一商户。完整的资金归属与结算模型请参考[账户与资金分配](/payments/cn/guides/amounts-and-balances#充币归属)。
