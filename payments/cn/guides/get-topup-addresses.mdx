...
5. 点击**创建**完成付款方创建。
<img src="/payments/cn/images/payments/create-payers.png" className="screenshot_full_screen" alt="创建付款方" />

#### 2. 获取充值地址
1. 在付款方列表中找到目标付款方，然后点击右侧的**查看地址**按钮。
<img src="/payments/cn/images/payments/view-address-button.png" className="screenshot_full_screen" alt="查看充值地址" />
2. 您可以在地址列表中查看已创建好的地址。如果您想要添加其他公链上的地址，可以点击**创建地址**按钮进行创建。
<img src="/payments/cn/images/payments/view-topup-addresses.png" className="screenshot_full_screen" alt="查看充值地址" />
3. 将所需充值地址提供给付款方，完成支付。
  </Tab>
  
  
  <Tab title="Payments API" icon="code">
1. 调用 [Create/Get top-up address](/payments/en/api-references/payment/createget-top-up-address) 创建充值地址。请求中的关键参数包括：
