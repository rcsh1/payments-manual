...
3. 在第三方钱包列表选择钱包并完成支付。
4. 页面将自动跳转至支付成功页面。
<img src="/payments/cn/images/payments/payment-link-mobile.png" className="screenshot_full_screen" alt="移动端 支付链接 页面" />
...
3. 在第三方钱包列表选择钱包并完成支付。
4. 页面将自动跳转至支付成功页面。
<img src="/payments/cn/images/payments/payment-link-desktop.png" className="screenshot_full_screen" alt="PC 支付链接 页面" />
...
<img src="/payments/cn/images/payments/payment-link-demo-page.png" className="screenshot_full_screen" alt="支付链接 Demo 页面" />
...
<img src="/payments/cn/images/payments/payment-link-request.png" className="screenshot_full_screen" alt="支付链接 预下单请求" />
...
- **汇率**：
    ...
    - 如果您未设置 `custom_exchange_rates` 字段，则系统会采用您设置的 `currency`（订单金额计价币种）与付款方实际选择的加密货币之间的实时汇率。该汇率以付款方下单时调用 [Get exchange rate](/payments/en/api-references/payment/get-exchange-rate) 返回的汇率为准。
