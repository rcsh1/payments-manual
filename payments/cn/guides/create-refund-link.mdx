...
<img src="/payments/cn/images/payments/refund-address-collection-default.png" className="screenshot_full_screen" alt="退款地址收集页面-默认地址" />

**更改退款地址页面**（需要填写新地址和Memo）：

<img src="/payments/cn/images/payments/refund-address-collection-change.png" className="screenshot_full_screen" alt="退款地址收集页面-更改地址" />
