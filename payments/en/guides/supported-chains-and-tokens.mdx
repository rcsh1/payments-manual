...
Exchange rates are updated every 10 minutes. You can query the current exchange rate using the [Get exchange rate API](/payments/en/api-references/payment/get-exchange-rate).
