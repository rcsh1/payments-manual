...
<Info>Token and chain combinations marked as "bridging fee required" incur additional bridging fees on top of regular fees when performing Off-Ramp operations. For example, converting BASE_USDC through Off-Ramp in the production environment requires an additional bridging fee.</Info>
