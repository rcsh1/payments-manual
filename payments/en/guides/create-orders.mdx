...
<Tabs>
  <Tab title="Create order" icon="code">
    ...
    - **Payable Currency (**`payable_currency`**)**:\
      The cryptocurrency you intend to collect from the payer. For supported cryptocurrencies, please refer to [Supported Currencies and Blockchains](/payments/en/guides/supported-chains-and-tokens).
    - **Payable Amount (**`payable_amount`**)**:\
      The amount of cryptocurrency you intend to collect from the payer, denominated in the currency specified by `payable_currency`.\
