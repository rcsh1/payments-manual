...
<img src="/payments/en/images/payments/view-orders.png" className="screenshot_full_screen" alt="View order list" />
  </Tab>
...
[Funds allocation and balances](/payments/en/guides/amounts-and-balances) details how Cobo handles funds in the case of overpayment, underpayment, and late payment.
...
6. In the pop-up form:
   ...
   - (Optional) Enter the developer fee amount. This fee will be deducted from the refund amount and credited to the developer balance. For a detailed description of developer fees, refer to [Funds allocation and balances](/payments/en/guides/amounts-and-balances).
...
<Info>For more information about developer fees, refer to [Funds allocation and balances](/payments/en/guides/amounts-and-balances).</Info>
