...
<Tabs>
  <Tab title="Create order" icon="code">
    You can call [Create pay-in order](/payments/en/api-references/payment/create-pay-in-order) to create a payment order.
    ...
    - **Developer Fee** (`fee_amount`): If you are a platform serving multiple downstream merchants and need to distribute revenue between you and your downstream merchants, you can set this fee to achieve that. The ratio between the developer fee and the pricing amount determines the revenue split between you and your downstream merchants. For more information, see [Accounts and fund allocation](/payments/en/guides/amounts-and-balances). <Info>
        If you are a merchant (serving users directly), you typically don't need to set the developer fee.
      </Info>
    - **Payable Amount** (`payable_amount`): The actual cryptocurrency amount that the user needs to pay, denominated in the cryptocurrency specified by `payable_currency`.
      - If you specify `payable_amount`, this value is used directly as the amount the payer needs to pay.
      - If you do not specify `payable_amount`, the system calculates it using the real-time exchange rate: **Payable Amount = (Pricing Amount + Developer Fee) / Exchange Rate**. The exchange rate is based on the rate returned by [Get exchange rate](/payments/en/api-references/payment/get-exchange-rate) at the time the order is created.

    The table below shows how the payable amount is determined in four different configuration scenarios:

    |                         | Scenario 1                                                                                             | Scenario 2                                                                                              | Scenario 3                                                                              | Scenario 4                                                                                          |
    | :---------------------- | :----------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------- |
    | Scenario Description    | - Pricing amount in fiat currency<br />- Developer fee not set<br />- System calculates payable amount | - Pricing amount in cryptocurrency<br />- Developer fee not set<br />- System calculates payable amount | - Pricing amount in fiat currency<br />- Developer fee set<br />- Custom payable amount | - Pricing amount in cryptocurrency<br />- Developer fee set<br />- System calculates payable amount |
    | `pricing_amount`        | `"100"`                                                                                                | `"100"`                                                                                                 | `"100"`                                                                                 | `"100"`                                                                                             |
    | `fee_amount`            | `"0"` or not set                                                                                       | `"0"` or not set                                                                                        | `"2"`                                                                                   | `"2"`                                                                                               |
    | `pricing_currency`      | `"USD"`                                                                                                | Not set                                                                                                 | `"USD"`                                                                                 | Not set                                                                                             |
    | `payable_currency`      | `"ETH_USDT"`                                                                                           | `"ETH_USDT"`                                                                                            | `"ETH_USDT"`                                                                            | `"ETH_USDT"`                                                                                        |
    | `payable_amount`        | Not set                                                                                                | Not set                                                                                                 | `"104.08"`                                                                              | Not set                                                                                             |
    | Real-time exchange rate | 0.99                                                                                                   | 1                                                                                                       | N/A (custom payable amount used)                                                        | 1                                                                                                   |
    | Calculation Process     | (100 + 0) / 0.99                                                                                       | (100 + 0) / 1                                                                                           | Directly uses specified payable_amount                                                  | (100 + 2) / 1                                                                                       |
