...
| 4002 | 400 | Your organization status does not permit this action. | Check your organization status in Cobo Portal under **Settings** > **Organization**. Your account may be under review or restricted. |
...
| 30031 | 400 | The token is not enabled for your organization. | Enable the token in Cobo Portal under **Wallets** > select your wallet > **Tokens**, then retry. |
| 30036 | 400 | The fee station balance is insufficient. The fee station needs to be recharged before transfers can proceed. | Add funds to your fee station wallet in Cobo Portal under **Fee Station**. |
| 30038 | 400 | The fee station token balance is insufficient to cover the gas fee for this transaction. | Recharge the fee station with the required fee token. |
| 30039 | 400 | Cobo's fee station balance is insufficient to cover the gas fee. | Recharge Cobo's fee station. Go to Cobo Portal under **Fee Station** and add the required gas token. |
