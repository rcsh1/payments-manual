...
* Refer to the [Developer guide](/payments/en/developer-tools/set-up-endpoint) to set up a callback endpoint and implement the processing logic.  
...
- For more information about merchant management use cases and descriptions, please refer to [Merchant management](/payments/en/guides/merchants).
...
Refer to the [Feature list](/payments/en/guides/features#payment-collection) to select the pay-in type suitable for you and refer to the documentation to complete payment collection feature integration.
