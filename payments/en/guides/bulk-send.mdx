...
<Note>
  Transaction hash (`tx_hash`) is not currently available through the public Payments API endpoints or webhooks. If your integration requires transaction hashes, please contact Cobo support.
</Note>
