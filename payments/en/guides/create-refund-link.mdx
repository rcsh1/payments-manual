...
<img src="/payments/en/images/payments/refund-address-collection-default.png" className="screenshot_full_screen" alt="Refund address collection page - default address" />

**Change refund address page** (requires filling in new address and Memo):

<img src="/payments/en/images/payments/refund-address-collection-change.png" className="screenshot_full_screen" alt="Refund address collection page - change address" />
