...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="/payments/en/guides/create-orders">Order mode</a> + <a href="/payments/en/guides/payment-link">Payment link</a> / <a href="/payments/en/guides/payment-toolkit">React SDK</a> (optional) + <a href="/payments/en/guides/fiat-payouts">Off-ramp</a></td>
    </tr>
    <tr>
...
As a payment service provider (PSP), you need to provide payment collection services for multiple merchants and achieve automated revenue sharing. A typical integration process is as follows:
  ...
  3. Integrate payment collection: Collect payments through [Order mode](/payments/en/guides/create-orders).
     ...
     - (Optional) Use [React SDK](/payments/en/guides/payment-toolkit) for customized development.
