...
<Note>This page covers **wallet-side** network-fee (gas fee) deduction behavior for end-user transfers: how a payer's own wallet or exchange handles gas when sending you a payment. It is unrelated to **Fee Management**, your Payments account for Cobo's own operational fees. For Cobo's fee charges and billing, see [Billing](/payments/en/guides/billing).</Note>
