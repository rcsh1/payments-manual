...
<Tabs>
  ...
  <Tab title="Payments API" icon="code">
    ...
    **Parameter description:**
    ...
    - `token_id`: Cryptocurrency ID (e.g., ETH_USDT, TRON_USDT).
    ...
    - `bank_account_id`: The identifier of the destination bank account you use for this withdrawal. Before you can use a bank account here, you must register it as a destination and have it approved by Cobo's operations team; see [Destinations](/payments/en/guides/destinations) for the registration and approval steps. You can retrieve your registered bank accounts by calling [List destination entries](/payments/en/api-references/payment/list-destination-entries) with `entry_type` set to `BankAccount`.
  </Tab>
</Tabs>
