...
<Tabs>
  <Tab title="Payments App" icon="pager">
    ...
    5. In the pop-up form:
       - Select a merchant. Deposits to this payer's top-up address are attributed through the payer and route to the merchant bound at the time the payer and address are created. For the complete deposit-routing model, see [Accounts and fund allocation](/payments/en/guides/amounts-and-balances#deposit-attribution).
    ...
    <img
      src="/payments/en/images/payments/create-payers.png"
    ...
    <img
      src="/payments/en/images/payments/view-address-button.png"
      className="screenshot_full_screen"
      alt="View top-up address"
    />
    ...
    <img
      src="/payments/en/images/payments/view-topup-addresses.png"
      className="screenshot_full_screen"
      alt="View top-up address"
    />
  ...
  <Tab title="Payments API" icon="code">
    ...
    2. **Configure top-up event listening**: Receive event notifications related to top-ups through webhooks. For details, refer to [Events and status](/payments/en/guides/status-and-events).
  </Tab>
</Tabs>
...
- **Fund handling**: The association between this address and the merchant still exists, so deposits continue routing to the same merchant after replacement. For the complete deposit-attribution and settlement model, see [Accounts and fund allocation](/payments/en/guides/amounts-and-balances#deposit-attribution).
