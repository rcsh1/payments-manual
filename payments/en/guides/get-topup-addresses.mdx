...
<img src="/payments/en/images/payments/create-payers.png" className="screenshot_full_screen" alt="Create payer" />

#### 2. Get top-up address
1. In the payer list, find the target payer, then click the **View Address** button on the right.
<img src="/payments/en/images/payments/view-address-button.png" className="screenshot_full_screen" alt="View top-up address" />
...
<img src="/payments/en/images/payments/view-topup-addresses.png" className="screenshot_full_screen" alt="View top-up address" />
...
When a top-up address has multiple transactions that fail to pass compliance screening, Cobo will automatically abandon that address and generate a new top-up address for the payer. After replacement, the `payment.address.updated` callback will be triggered. For details, refer to [Events and status](/payments/en/guides/status-and-events).
