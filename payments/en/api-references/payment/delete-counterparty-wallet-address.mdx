...
```python Python
import cobo_waas2
from cobo_waas2.models.delete_counterparty_wallet_address200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.delete_counterparty_wallet_address(
            wallet_address_id
        )
        ...
        print(
            "Exception when calling PaymentApi->delete_counterparty_wallet_address: %s\n"
            % e
        )
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      DeleteCounterpartyWalletAddress200Response result =
          apiInstance.deleteCounterpartyWalletAddress(walletAddressId);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.DeleteCounterpartyWalletAddress(ctx, walletAddressId).
		Execute()
	if err != nil {
		fmt.Fprintf(
			os.Stderr,
			"Error when calling `PaymentAPI.DeleteCounterpartyWalletAddress``: %v\n",
			err,
		)
...
apiInstance.deleteCounterpartyWalletAddress(wallet_address_id).then(
  (data) => {
