...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListAllocationItems200Response result =
          apiInstance.listAllocationItems(
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.ListAllocationItems(ctx).
		Limit(limit).
		Before(before).
		After(after).
...
apiInstance.listAllocationItems(opts).then(
  (data) => {
