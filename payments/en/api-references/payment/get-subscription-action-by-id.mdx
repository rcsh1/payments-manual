---
openapi: get /payments/subscription_actions/{action_id}
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.payment_subscription_action_detail import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print(
            "Exception when calling PaymentApi->get_subscription_action_by_id: %s\n" % e
        )
...
func main() {
	...
	if err != nil {
		fmt.Fprintf(
			os.Stderr,
			"Error when calling `PaymentAPI.GetSubscriptionActionById``: %v\n",
			err,
		)
...
apiInstance.getSubscriptionActionById(action_id).then(
  (data) => {
