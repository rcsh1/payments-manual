---
openapi: post /payments/subscription_plans
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.payment_create_subscription_plan import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.create_subscription_plan(
...
public class Example {
  public static void main(String[] args) {
    ...
    PaymentCreateSubscriptionPlan paymentCreateSubscriptionPlan =
        new PaymentCreateSubscriptionPlan()
            .developerPlanId("123e457-e89b-12d3-a456-426614174004")
            .periodType(PaymentSubscriptionPeriodType.YEARLY)
            .periods(12)
            .amount("500.00");
    try {
      PaymentSubscriptionPlan result =
          apiInstance.createSubscriptionPlan(paymentCreateSubscriptionPlan);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.CreateSubscriptionPlan(ctx).
		PaymentCreateSubscriptionPlan(paymentCreateSubscriptionPlan).
		Execute()
	if err != nil {
...
const opts = {
  PaymentCreateSubscriptionPlan:
    CoboWaas2.PaymentCreateSubscriptionPlan.constructFromObject({
      developer_plan_id: "123e457-e89b-12d3-a456-426614174004",
      period_type: "Yearly",
      periods: 12,
      amount: "500.00",
...
apiInstance.createSubscriptionPlan(opts).then(
  (data) => {
