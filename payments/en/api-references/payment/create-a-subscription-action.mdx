---
openapi: post /payments/subscription_actions
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.payment_create_subscription_action import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.create_subscription_action(
...
public class Example {
  public static void main(String[] args) {
    ...
    PaymentCreateSubscriptionAction paymentCreateSubscriptionAction =
        new PaymentCreateSubscriptionAction()
            .requestId("123e457-e89b-12d3-a456-426614174004")
            .planId("123e457-e89b-12d3-a456-426614174004")
            .merchantId("123e457-e89b-12d3-a456-426614174004");
    try {
      PaymentSubscriptionAction result =
          apiInstance.createSubscriptionAction(paymentCreateSubscriptionAction);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.CreateSubscriptionAction(ctx).
		PaymentCreateSubscriptionAction(paymentCreateSubscriptionAction).
		Execute()
	if err != nil {
		fmt.Fprintf(
			os.Stderr,
			"Error when calling `PaymentAPI.CreateSubscriptionAction``: %v\n",
			err,
		)
...
const opts = {
  PaymentCreateSubscriptionAction:
    CoboWaas2.PaymentCreateSubscriptionAction.constructFromObject({
      request_id: "123e457-e89b-12d3-a456-426614174004",
      plan_id: "123e457-e89b-12d3-a456-426614174004",
      merchant_id: "123e457-e89b-12d3-a456-426614174004",
    }),
};
apiInstance.createSubscriptionAction(opts).then(
  (data) => {
