---
openapi: get /payments/topup/payer_accounts
---

<RequestExample>
```python Python
import cobo_waas2
from cobo_waas2.models.list_top_up_payer_accounts200_response import (
...
with cobo_waas2.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        api_response = api_instance.list_top_up_payer_accounts(
            limit=limit,
            before=before,
            after=after,
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ListTopUpPayerAccounts200Response result =
          apiInstance.listTopUpPayerAccounts(limit, before, after, merchantId, payerId);
...
func main() {
	...
	resp, r, err := apiClient.PaymentAPI.ListTopUpPayerAccounts(ctx).
		Limit(limit).
		Before(before).
		After(after).
...
apiInstance.listTopUpPayerAccounts(opts).then(
  (data) => {
