...
lang: "en"
description: "Guide to authenticating API requests to the Cobo payments service using Cobo Auth, including API key and signature details."
---

This article explains how to authenticate your API requests to the Cobo payments service using Cobo Auth. 
...
- The API key is included in API requests to identify the client to the Cobo payments service. It is required to be registered on Cobo Portal. For more information, refer to [Register an API key](https://manuals.cobo.com/en/portal/developer-console/create-api-key).
...
Cobo Command Line Interface (CLI) is a powerful developer tool designed to help you build, test, and manage your integration with Cobo Payments API directly from the command line.
