...
|-------------|------------------------|-------|
| Binance Wallet | Transfers through **Binance Wallet** use external deduction, but transfers through **Binance Exchange** use internal deduction | Transfer through **Binance Exchange**: <img src="/en/images/payments/binance_wallet.png" className="screenshot_modal" alt="Binance Wallet" /> |
| MetaMask | No | - |
| Trust Wallet | No | - |
| Rainbow | No | - |
| Coinbase Wallet | No | - |
