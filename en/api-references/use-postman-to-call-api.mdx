---
title: "Use Postman to call the Payments API"
lang: "en"
sidebarTitle: "Use Postman to call the Payments API"
description: "Guide to using Postman for calling the Payments API."
---

## **Overview**

This guide introduces how to use Postman to call the Payments API.
...
1. Download the Payments API specification from [GitHub](https://github.com/CoboGlobal/developer-site/blob/master/v2/cobo_waas2_openapi_spec/dev_openapi.yaml).
