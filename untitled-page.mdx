---
title: "Bulk Send 集成指南e"
description: "Bulk Send 用于一次性向多个收款地址批量转账，适用于工资发放、返佣奖励、合作方结算、电商/广告平台商家收益分发等场景。您只需提交包含多条 payout item 的请求，Cobo 将为每条 item 执行地址校验与合规验证（KYA），并根据执行模式（execution mode）决定是否继续链上转账。"
---
...
| **execution_mode** | **校验阶段发现任意地址有问题<br />（ KYA 不通过）** | **链上转账结果**                             | **您需要做什么**                               |
| :----------------- | :-------------------------------- | :------------------------------------- | :--------------------------------------- |
