...
2. 点击左下角的**指南**，然后点击**绑定 Cobo Guard**。
   <img src="/cn/images/payments/cobo-guard.png" className="screenshot_nav_bar" alt="绑定 Cobo Guard"/>
...
2. 在首页点击 **Payments** 卡片。
<img src="/cn/images/payments/install-payment-app.png" className="screenshot_modal" alt="Payments App Intro" />
